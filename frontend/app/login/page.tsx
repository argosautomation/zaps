        ...
        <div className="mb-8 text-center lg:text-left">
            ...
            <form className="space-y-6 mt-6" onSubmit={handleSubmit}>
                ...
                {step === 'credentials' ? (
                    ...
                    <div>
                        <label htmlFor="code" className="block text-sm font-medium mb-2 text-slate-300">
                            Authentication Code
                        </label>
                        <input
                            id="code"
                            ...
                            className="w-full px-4 py-3 bg-slate-900/50 border border-slate-700 rounded-lg focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 focus:outline-none text-white placeholder-slate-500 transition-all font-sans text-center tracking-[0.5em] text-xl"
                            placeholder="000000"
                        />
                    </div>
                )}
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white py-3.5 rounded-lg font-bold text-lg transition-all shadow-lg shadow-cyan-500/20 disabled:opacity-50 disabled:cursor-not-allowed mt-4"
                >
                    {loading ? (
